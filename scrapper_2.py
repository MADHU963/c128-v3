...
browser = webdriver.Chrome("D:\proPython\c128\web-scrapping-2\chromedriver_win32\chromedriver.exe")
...
def scrape():
 ...
 #Create the function in loop and pass the hyperlink we saved with the earlier function in this scrape more data function.      
